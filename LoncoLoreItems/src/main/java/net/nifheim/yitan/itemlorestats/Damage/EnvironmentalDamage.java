 ...
 public class EnvironmentalDamage implements org.bukkit.event.Listener
 {
   ...
   net.nifheim.yitan.itemlorestats.Enchants.Vanilla_FeatherFalling vanilla_FeatherFalling = new net.nifheim.yitan.itemlorestats.Enchants.Vanilla_FeatherFalling();
