...
public class InventorySerializer {
     ...
     *
     * @param o The map to deserialize from. 
     ...
     */
    public static ItemStack deserialize(Object o) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
