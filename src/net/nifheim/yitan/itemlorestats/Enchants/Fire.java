 ...
 public class Fire
 {
   ...
   public void fireChanceOnHit(LivingEntity getDefender, LivingEntity getAttacker, boolean isTool) {
     if (this.gearStats.getFireGear(getAttacker) + this.gearStats.getFireItemInHand(Main.plugin.itemInMainHand(getAttacker)) + this.gearStats.getFireItemInHand(Main.plugin.itemInOffHand(getAttacker)) <= 0.0D) { return;
     }
