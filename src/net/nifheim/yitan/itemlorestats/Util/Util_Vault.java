...
public class Util_Vault {
    ...
    public boolean setupEconomy() {
        ...
        org.bukkit.plugin.RegisteredServiceProvider<Economy> rsp = Main.plugin.getServer().getServicesManager().getRegistration(Economy.class);
    ...
    public void removeMoneyForRepair(Player player, String type, String material) {
        ...
        int currentBalanceToBeDeducted = Main.plugin.getConfig().getInt("durabilityAddedOnEachRepair.repairCurrencyCost." + type + "." + material);
    ...
    public void removeMoneyForSale(Player player, int stackSize) {
        ...
        if (player.getInventory().getItemInMainHand().getType() != Material.AIR) {
            int currentBalanceToBeAdded = this.gearStats.getSellValueItemInHand(Main.plugin.itemInMainHand(player)) * stackSize;
