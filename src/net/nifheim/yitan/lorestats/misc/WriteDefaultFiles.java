...
//    }
    public void checkExistence() {
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedItems").exists()) {
            new File(Main.getInstance().getDataFolder() + File.separator + "SavedItems").mkdirs();
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedMobs").exists()) {
            new File(Main.getInstance().getDataFolder() + File.separator + "SavedMobs").mkdirs();
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells").exists()) {
            new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells").mkdirs();
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "PlayerData").exists()) {
            new File(Main.getInstance().getDataFolder() + File.separator + "PlayerData").mkdirs();
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "language-en.yml").exists()) {
            writeLanguageEN();
        }
        new File(Main.getInstance().getDataFolder() + File.separator + "language-de.yml").exists();

        new File(Main.getInstance().getDataFolder() + File.separator + "language-pl.yml").exists();

        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Fireball.yml").exists()) {
            writeDefaultSpell("Fireball", "SmallFireball", 2, "Mobspawner_Flames", 15, 0, 0, 0, 5, 2, 2);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Fireball I.yml").exists()) {
            writeDefaultSpell("Fireball I", "SmallFireball", 2, "Mobspawner_Flames", 15, 0, 0, 0, 8, 5, 2);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Fireball II.yml").exists()) {
            writeDefaultSpell("Fireball II", "SmallFireball", 2, "Mobspawner_Flames", 15, 0, 0, 0, 11, 8, 3);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Fireball III.yml").exists()) {
            writeDefaultSpell("Fireball III", "SmallFireball", 2, "Mobspawner_Flames", 15, 0, 0, 0, 14, 10, 3);
        }

        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Frostbolt.yml").exists()) {
            writeDefaultSpell("Frostbolt", "Snowball", 2, "Potion_Break", 15, 0, 0, 0, 5, 2, 2);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Frostbolt I.yml").exists()) {
            writeDefaultSpell("Frostbolt I", "Snowball", 2, "Potion_Break", 15, 0, 0, 0, 8, 5, 2);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Frostbolt II.yml").exists()) {
            writeDefaultSpell("Frostbolt II", "Snowball", 2, "Potion_Break", 15, 0, 0, 0, 11, 8, 3);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Frostbolt III.yml").exists()) {
            writeDefaultSpell("Frostbolt III", "Snowball", 2, "Potion_Break", 15, 0, 0, 0, 14, 10, 3);
        }

        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Minor Heal.yml").exists()) {
            writeDefaultSpell("Minor Heal", "Snowball", 3, "Ender_Signal", 4, 4, 0, 0, 0, 0, 0);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Minor Heal I.yml").exists()) {
            writeDefaultSpell("Minor Heal I", "Snowball", 3, "Ender_Signal", 4, 5, 0, 0, 0, 0, 0);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Minor Heal II.yml").exists()) {
            writeDefaultSpell("Minor Heal II", "Snowball", 3, "Ender_Signal", 4, 6, 0, 0, 0, 0, 0);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Minor Heal III.yml").exists()) {
            writeDefaultSpell("Minor Heal III", "Snowball", 3, "Ender_Signal", 4, 7, 0, 0, 0, 0, 0);
        }

        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Major Heal.yml").exists()) {
            writeDefaultSpell("Major Heal", "Snowball", 3, "Ender_Signal", 8, 10, 0, 0, 0, 0, 0);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Major Heal I.yml").exists()) {
            writeDefaultSpell("Major Heal I", "Snowball", 3, "Ender_Signal", 8, 11, 0, 0, 0, 0, 0);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Major Heal II.yml").exists()) {
            writeDefaultSpell("Major Heal II", "Snowball", 3, "Ender_Signal", 8, 12, 0, 0, 0, 0, 0);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Major Heal III.yml").exists()) {
            writeDefaultSpell("Major Heal III", "Snowball", 3, "Ender_Signal", 8, 13, 0, 0, 0, 0, 0);
        }

        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Minor AOE Heal.yml").exists()) {
            writeDefaultSpell("Minor AOE Heal", "Snowball", 8, "Ender_Signal", 8, 8, 8, 2, 0, 0, 0);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Minor AOE Heal I.yml").exists()) {
            writeDefaultSpell("Minor AOE Heal I", "Snowball", 8, "Ender_Signal", 8, 9, 9, 2, 0, 0, 0);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Minor AOE Heal II.yml").exists()) {
            writeDefaultSpell("Minor AOE Heal II", "Snowball", 8, "Ender_Signal", 8, 10, 10, 3, 0, 0, 0);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Minor AOE Heal III.yml").exists()) {
            writeDefaultSpell("Minor AOE Heal III", "Snowball", 8, "Ender_Signal", 8, 11, 11, 3, 0, 0, 0);
        }

        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Major AOE Heal.yml").exists()) {
            writeDefaultSpell("Major AOE Heal", "Snowball", 8, "Ender_Signal", 16, 14, 14, 3, 0, 0, 0);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Major AOE Heal I.yml").exists()) {
            writeDefaultSpell("Major AOE Heal I", "Snowball", 8, "Ender_Signal", 16, 15, 15, 3, 0, 0, 0);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Major AOE Heal II.yml").exists()) {
            writeDefaultSpell("Major AOE Heal II", "Snowball", 8, "Ender_Signal", 16, 16, 16, 4, 0, 0, 0);
        }
        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + "Major AOE Heal III.yml").exists()) {
            writeDefaultSpell("Major AOE Heal III", "Snowball", 8, "Ender_Signal", 16, 17, 17, 4, 0, 0, 0);
        }

        if (!new File(Main.getInstance().getDataFolder() + File.separator + "SavedItems" + File.separator + "SetBonuses.yml").exists()) {
            writeSetBonuses();
        }
    }
    ...
    public void writeDefaultSpell(String fileName, String projType, int projVelocity, String projHitEff, int cooldown, int dHA, int aHA, int aHR, int dDA, int aDA, int aDR) {
        try {
            ...
            this.PlayerDataFile = new File(Main.getInstance().getDataFolder() + File.separator + "SavedSpells" + File.separator + fileName + ".yml");
            ...
            Main.getInstance().getLogger().log(Level.WARNING, "Failed to save the default spell config for {0}.", fileName);
        }
    }
    ...
    public void writeSetBonuses() {
        try {
            this.PlayerDataConfig = new YamlConfiguration();
            this.PlayerDataFile = new File(Main.getInstance().getDataFolder() + File.separator + "SavedItems" + File.separator + "SetBonuses.yml");
    ...
    public void writeLanguageEN() {
        try {
            this.PlayerDataConfig = new YamlConfiguration();
            this.PlayerDataFile = new File(Main.getInstance().getDataFolder() + File.separator + "language-en.yml");
