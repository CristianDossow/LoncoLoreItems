...
public class GearStats implements org.bukkit.event.Listener {
    ...
    public String getTotalMovementSpeed(Player player) {
        double stat = Double.valueOf(player.getLevel()).doubleValue() * Main.getInstance().getConfig().getDouble("additionalStatsPerLevel.speed") * 100;

        if (Main.getInstance().isTool(Main.getInstance().itemInMainHand(player).getType())) {
            stat += getMovementSpeedItemInHand(Main.getInstance().itemInMainHand(player));
        }

        if (Main.getInstance().isTool(Main.getInstance().itemInOffHand(player).getType())) {
            stat += getMovementSpeedItemInHand(Main.getInstance().itemInOffHand(player));
        }
    ...
    public double getArmourGear(LivingEntity entity) {
        this.armour = Main.getInstance().getConfig().getString("primaryStats.armour.name").replaceAll(" ", "");
    ...
    public double getDodgeGear(LivingEntity entity) {
        this.dodge = Main.getInstance().getConfig().getString("secondaryStats.dodge.name").replaceAll(" ", "");
    ...
    public double getBlockGear(LivingEntity entity) {
        this.block = Main.getInstance().getConfig().getString("secondaryStats.block.name").replaceAll(" ", "");
    ...
    public String getPlayerDamage(Player player) {
        ...
        mindamage = mindamage + Double.parseDouble(getDamageItemInHand(Main.getInstance().itemInMainHand(player)).split("-")[0]);
        maxdamage = maxdamage + Double.parseDouble(getDamageItemInHand(Main.getInstance().itemInMainHand(player)).split("-")[1]);
    ...
    public String getDamageGear(LivingEntity entity) {
        ...
        this.damage = Main.getInstance().getConfig().getString("primaryStats.damage.name").replaceAll(" ", "");
        if (entity != null) {
    ...
    public double getCritChanceGear(LivingEntity entity) {
        this.critChance = Main.getInstance().getConfig().getString("secondaryStats.critChance.name").replaceAll(" ", "");
    ...
    public double getCritDamageGear(LivingEntity entity) {
        this.critDamage = Main.getInstance().getConfig().getString("secondaryStats.critDamage.name").replaceAll(" ", "");
    ...
    public double getHealthGear(LivingEntity entity) {
        this.health = Main.getInstance().getConfig().getString("primaryStats.health.name").replaceAll(" ", "");
    ...
    public double getHealthRegenGear(LivingEntity entity) {
        this.healthRegen = Main.getInstance().getConfig().getString("primaryStats.healthRegen.name").replaceAll(" ", "");
    ...
    public double getLifeStealGear(LivingEntity entity) {
        this.lifeSteal = Main.getInstance().getConfig().getString("secondaryStats.lifeSteal.name").replaceAll(" ", "");
    ...
    public double getLifeStealHealGear(LivingEntity entity) {
        this.lifeStealHeal = Main.getInstance().getConfig().getString("secondaryStats.lifeStealHeal.name").replaceAll(" ", "");
    ...
    public double getReflectGear(LivingEntity entity) {
        this.reflect = Main.getInstance().getConfig().getString("secondaryStats.reflect.name").replaceAll(" ", "");
    ...
    public double getFireGear(LivingEntity entity) {
        this.fire = Main.getInstance().getConfig().getString("secondaryStats.fire.name").replaceAll(" ", "");
    ...
    public double getIceGear(LivingEntity entity) {
        this.ice = Main.getInstance().getConfig().getString("secondaryStats.ice.name").replaceAll(" ", "");
    ...
    public double getPoisonGear(LivingEntity entity) {
        this.poison = Main.getInstance().getConfig().getString("secondaryStats.poison.name").replaceAll(" ", "");
    ...
    public double getWitherGear(LivingEntity entity) {
        this.wither = Main.getInstance().getConfig().getString("secondaryStats.wither.name").replaceAll(" ", "");
    ...
    public double getHarmingGear(LivingEntity entity) {
        this.harming = Main.getInstance().getConfig().getString("secondaryStats.harming.name").replaceAll(" ", "");
    ...
    public double getBlindGear(LivingEntity entity) {
        this.blind = Main.getInstance().getConfig().getString("secondaryStats.blind.name").replaceAll(" ", "");
    ...
    public double getMovementSpeedGear(Player player) {
        this.movementspeed = Main.getInstance().getConfig().getString("secondaryStats.movementSpeed.name").replaceAll(" ", "");
    ...
    public double getXPMultiplierGear(Player player) {
        this.xpmultiplier = Main.getInstance().getConfig().getString("bonusStats.xpMultiplier.name").replaceAll(" ", "");
    ...
    public double getPvPDamageModifierItemInHand(ItemStack item) {
        this.pvpdamage = Main.getInstance().getConfig().getString("bonusStats.pvpDamage.name").replaceAll(" ", "");
    ...
    public double getPvEDamageModifierItemInHand(ItemStack item) {
        this.pvedamage = Main.getInstance().getConfig().getString("bonusStats.pveDamage.name").replaceAll(" ", "");
    ...
    public int getSellValueItemInHand(ItemStack item) {
        this.sellValueName = Main.getInstance().getConfig().getString("bonusStats.sellValue.name").replaceAll(" ", "");
        this.currencyName = Main.getInstance().getConfig().getString("bonusStats.sellValue.currency.name").replaceAll(" ", "");
    ...
    public int getXPLevelRequirement(Player player, ItemStack item) {
        this.xplevel = Main.getInstance().getConfig().getString("bonusStats.xpLevel.name").replaceAll(" ", "");
    ...
    public String getSoulboundName(Player player, ItemStack item) {
        this.soulbound = Main.getInstance().getConfig().getString("bonusStats.soulbound.name");
    ...
    public ArrayList<String> getClass(ItemStack item) {
        this.className = Main.getInstance().getConfig().getString("bonusStats.class.name").replaceAll(" ", "");
        ...
        if ((item != null)
            ...
            for (String line : itemLore) {
                if (ChatColor.stripColor(line).startsWith(this.className + ": ")) {
                    ...
                    ArrayList<String> storeLoreValues = new ArrayList(java.util.Arrays.asList(value.split(Main.getInstance().getConfig().getString("bonusStats.class.separator"))));
                    return storeLoreValues;
                }
            }
        }
    ...
    public String phic_SetBonusItemInHand(ItemStack itemstack) {
        this.setbonus = Main.getInstance().getConfig().getString("bonusStats.setBonus.name").replaceAll(" ", "");
        String weaponKey = "";
        ...
        if ((itemInHand != null)
                ...
                && (Main.getInstance().isTool(itemInHand.getType()))
