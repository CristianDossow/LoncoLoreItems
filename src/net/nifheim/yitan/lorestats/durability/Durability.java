...
public class Durability {
    ...
    private void setDurabilityStrings() {
        if (this.durabilityName == null) {
            this.above75 = this.util_Colours.replaceTooltipColour(Main.getInstance().getConfig().getString("bonusStats.durability.warningColours.above75%"));
            this.above50 = this.util_Colours.replaceTooltipColour(Main.getInstance().getConfig().getString("bonusStats.durability.warningColours.above50%"));
            this.above25 = this.util_Colours.replaceTooltipColour(Main.getInstance().getConfig().getString("bonusStats.durability.warningColours.above25%"));
            this.above0 = this.util_Colours.replaceTooltipColour(Main.getInstance().getConfig().getString("bonusStats.durability.warningColours.above0%"));
            this.durabilityName = Main.getInstance().getConfig().getString("bonusStats.durability.name");
            this.durabilitySplitter = Main.getInstance().getConfig().getString("bonusStats.durability.splitter");
        }
    }
    ...
    public String calculateNewDurability(int newValue, String maxValue, String durabilityPrefixColour, String durabilityAmountColour, ItemStack item, Player player) {
        ...
        if (newValue < maximumValue / 4) {
            if ((newValue == maximumValue / 4) && (Main.getInstance().getConfig().getBoolean("displayDurabilityWarnings.enableAbove0%DurabilityWarning"))) {
            ...
            if ((newValue == maximumValue / 2) && (Main.getInstance().getConfig().getBoolean("displayDurabilityWarnings.enableAbove25%DurabilityWarning"))) {
            ...
            if ((newValue == maximumValue / 4 * 3) && (Main.getInstance().getConfig().getBoolean("displayDurabilityWarnings.enableAbove50%DurabilityWarning"))) {
    ...
    public void durabilityCalcForItemInHand(Player player, int amount, String durabilityLost, ItemStack itemInHand, String handType) {
        ...
        if ((itemInHand != null) && (Main.getInstance().isTool(itemInHand.getType()))
    ...
    public void durabilityCalcForArmour(Entity getDefender, int amount, String durabilityLost) {
        if ((getDefender instanceof Player)) {
            ...
            if ((((Player) getDefender).getInventory().getHelmet() != null) && (Main.getInstance().isHelmet(((Player) getDefender).getInventory().getHelmet().getType()))
                ...
                getItemLore.stream().filter((getDurability) -> (ChatColor.stripColor(getDurability).startsWith(this.durabilityName))).forEachOrdered((getDurability) -> {
                    String durabilityRebuilder;
                    String durabilityAmountColour;
                    String prefixColourOnly;
                    ...
                    double value = (calculateNewValue / Double.valueOf(maximumValue));
            ...
            if ((((Player) getDefender).getInventory().getChestplate() != null) && (Main.getInstance().isChestplate(((Player) getDefender).getInventory().getChestplate().getType()))
            ...
            if ((((Player) getDefender).getInventory().getLeggings() != null) && (Main.getInstance().isLeggings(((Player) getDefender).getInventory().getLeggings().getType()))
            ...
            if ((((Player) getDefender).getInventory().getBoots() != null) && (Main.getInstance().isBoots(((Player) getDefender).getInventory().getBoots().getType()))
            ...
            if ((((LivingEntity) getDefender).getEquipment().getHelmet() != null) && (Main.getInstance().isHelmet(((LivingEntity) getDefender).getEquipment().getHelmet().getType()))) {
            ...
            if ((((LivingEntity) getDefender).getEquipment().getChestplate() != null) && (Main.getInstance().isChestplate(((LivingEntity) getDefender).getEquipment().getChestplate().getType()))) {
            ...
            if ((((LivingEntity) getDefender).getEquipment().getLeggings() != null) && (Main.getInstance().isLeggings(((LivingEntity) getDefender).getEquipment().getLeggings().getType()))) {
            ...
            if ((((LivingEntity) getDefender).getEquipment().getBoots() != null) && (Main.getInstance().isBoots(((LivingEntity) getDefender).getEquipment().getBoots().getType()))) {
