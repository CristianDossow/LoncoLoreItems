...
public class Repair {
    ...
    public void repair(Player player, String type, String material) {
        int repairCost = Main.getInstance().getConfig().getInt("durabilityAddedOnEachRepair." + type + "." + material);
    ...
    public void payAndRepair(Player player, Material type) {
        if (!isFullDurability(player)) {
            if (Main.getInstance().getConfig().getString("durabilityAddedOnEachRepair.repairCostType").equalsIgnoreCase("Currency")) {
                if (type.equals(Material.WOOD_AXE)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "tools", "wood");
                } else if (type.equals(Material.STONE_AXE)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "tools", "stone");
                } else if (type.equals(Material.IRON_AXE)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "tools", "iron");
                } else if (type.equals(Material.GOLD_AXE)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "tools", "gold");
                } else if (type.equals(Material.DIAMOND_AXE)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "tools", "diamond");
                    ...
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "tools", "shears");
                } else if (type.equals(Material.BOW)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "tools", "bow");
                } else if (type.equals(Material.STICK)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "tools", "stick");
                } else if (type.equals(Material.FLINT_AND_STEEL)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "tools", "flintAndSteel");
                } else if (type.equals(Material.FISHING_ROD)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "tools", "fishingRod");
                } else if (type.equals(Material.CARROT_STICK)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "tools", "carrotStick");
                } else if (type.equals(Material.SHEARS)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "tools", "shears");
                } else if (type.equals(Material.LEATHER_HELMET)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "armour", "leather");
                } else if (type.equals(Material.CHAINMAIL_HELMET)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "armour", "chainmail");
                } else if (type.equals(Material.IRON_HELMET)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "armour", "iron");
                } else if (type.equals(Material.GOLD_HELMET)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "armour", "gold");
                } else if (type.equals(Material.DIAMOND_HELMET)) {
                    Main.getInstance().util_Vault.removeMoneyForRepair(player, "armour", "diamond");
