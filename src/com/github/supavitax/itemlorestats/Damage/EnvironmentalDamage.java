 ...
 public class EnvironmentalDamage implements org.bukkit.event.Listener
 {
   ...
   com.github.supavitax.itemlorestats.Util.Util_EntityManager util_EntityManager = new com.github.supavitax.itemlorestats.Util.Util_EntityManager();
   
   com.github.supavitax.itemlorestats.Enchants.Vanilla_FeatherFalling vanilla_FeatherFalling = new com.github.supavitax.itemlorestats.Enchants.Vanilla_FeatherFalling();
   ...
   public void onBlockExplosion(EntityDamageEvent event) {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.BLOCK_EXPLOSION)) && 
       ...
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.block_explosion.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.block_explosion.damage");
   ...
   public void onCactus(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.CONTACT)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.cactus.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.cactus.damage");
   ...
   public void onDrowning(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.DROWNING)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.drowning.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.drowning.damage");
   ...
   public void onEntityExplosion(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.ENTITY_EXPLOSION)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.entity_explosion.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.entity_explosion.damage");
   ...
   public void onFallDamage(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.FALL)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.fall.damage") == 0) { return;
         }
         ...
         double percentageOfHealth = ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.fall.damage") * entity.getMaxHealth() / 100.0D;
   ...
   public void onFire(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.FIRE)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.fire.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.fire.damage");
   ...
   public void onFireTick(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.FIRE_TICK)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.fire_tick.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.fire_tick.damage");
   ...
   public void onLavaBurn(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.LAVA)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.lava.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.lava.damage");
   ...
   public void onLightningStrike(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.LIGHTNING)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.lightning.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.lightning.damage");
   ...
   public void onMagic(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.MAGIC)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.magic.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.magic.damage");
   ...
   public void onPoison(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.POISON)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.poison.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.poison.damage");
   ...
   public void onStarvation(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.STARVATION)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.starvation.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.starvation.damage");
   ...
   public void onSuffocation(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.SUFFOCATION)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.suffocation.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.suffocation.damage");
   ...
   public void onThorns(EntityDamageEvent event)
   {
     if ((event.getCause().equals(EntityDamageEvent.DamageCause.THORNS)) && 
       ...
       if (!ItemLoreStats.plugin.getConfig().getStringList("disabledInWorlds").contains(entity.getWorld().getName()))
       {
         if (ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.thorns.damage") == 0) { return;
         }
         double newDamage = entity.getMaxHealth() / 100.0D * ItemLoreStats.plugin.getConfig().getInt("environmentalDamage.thorns.damage");
